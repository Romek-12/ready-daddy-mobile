...
const darkColors = {
  ...
  primary: '#00E5C0',
  primaryDark: '#00B89B',
  primaryLight: 'rgba(0,229,192,0.22)',
  violet: '#A855F7',
  violetSoft: 'rgba(168,85,247,0.22)',
  primaryGlow: 'rgba(0,229,192,0.65)',
  violetGlow: 'rgba(168,85,247,0.65)',
  surfaceBase: '#050505',
  accent: '#FFB547',
  accentLight: 'rgba(255,181,71,0.20)',

  text: '#F0FAF7',
  textSecondary: 'rgba(240,250,247,0.70)',
  textMuted: 'rgba(240,250,247,0.45)',
